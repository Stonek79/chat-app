...
export const SERVER_EVENT_CHAT_DELETED = 'server:chat_deleted';
...
export const SERVER_EVENT_USER_STATUS_CHANGED = 'server:user_status_changed';
...
export const CLIENT_EVENT_TYPING = 'client:typing';

// Серверные события печати
export const SERVER_EVENT_TYPING_STARTED = 'server:typing_started';
export const SERVER_EVENT_TYPING_STOPPED = 'server:typing_stopped';
