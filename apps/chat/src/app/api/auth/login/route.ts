...
import { AUTH_TOKEN_COOKIE_NAME, loginSchema, toClientUser } from '@chat-app/core';
...
export async function POST(req: NextRequest) {
    try {
        ...
        // TODO: Раскомментировать, когда будет реализована отправка email для верификации
        // if (!user.isVerified) {
