...
export const SERVER_EVENT_MESSAGE_DELETED = 'server:message_deleted'; // Сообщение удалено
...
export const CLIENT_EVENT_DELETE_MESSAGE = 'client:delete_message'; // Клиент удаляет сообщение
